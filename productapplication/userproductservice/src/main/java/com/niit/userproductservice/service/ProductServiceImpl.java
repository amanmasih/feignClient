...
public class ProductServiceImpl implements ProductService{
    ...
    @Autowired
    public ProductServiceImpl(ProductRepository productRepository, UserProxy userProxy) {
    ...
    public Customer registerNewCustomer(Customer customer) throws CustomerAlreadyExist {
        ...
        //from UserProxy for fiegn client configuration
        ResponseEntity response =userProxy.saveUser(customer);
